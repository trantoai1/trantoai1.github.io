...
<!-- <script>
	window.onload = function(){
		let c = document.getElementsByClassName('blog-content')[0];
		c.innerHTML = "${content}";
	}
</script> -->
</head>
						...
						<div class="page-wrapper">
							<div class="blog-title-area text-center">
								...
								<span class="color-orange"><a
									href="tech-category-01.html" title="">${ topic }</a></span>

								<h3>${ title }</h3>

								<div class="blog-meta big-meta">
									<small><a href="tech-single.html" title="">21 July,
											2017</a></small> <small><a href="tech-author.html" title="">by
											Jessica</a></small> <small><a href="#" title=""><i
											class="fa fa-eye"></i> 2344</a></small>
								</div>
								<!-- end meta -->
